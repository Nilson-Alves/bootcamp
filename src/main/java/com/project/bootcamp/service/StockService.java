...
//CAMADA SERVICE =>
//=> INTERMEDIÁRIA QUE CONVERSA COM CONTROLLER E COM DEMAIS CAMADAS =>
// => REPOSITORY => MAPPER =>VALIDATION => OTHERS...QUE ATENDE AO NEGÓCIO.
@Service
public class StockService {
    ...
    public StockDTO update(StockDTO dto) {
        Optional<Stock> optionalStock = repository.findByIdStockUpdate(dto.getName(), dto.getDate(), dto.getId());
